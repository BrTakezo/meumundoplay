...
<main style="background:url(.);background-repeat:no-repeat;background-attachment:fixed;background-size:cover;">
    <div id="primary" class="p-t-b-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mx-md-auto">
                    <div class="text-center">
                        <img src="./fonts/roboto/.png" alt="">
                    </div>
...
<br><br>
<p class="float-right">By <a href="https://realmofapknpanels.com">Realm Of Apk n Panels</a>&emsp;</p>
<p class="float-right">Version <a href="https://realmofapknpanels.com">XC</a>&emsp;</p>
</body>
</html>